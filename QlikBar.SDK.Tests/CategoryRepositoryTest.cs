...
namespace QlikBar.SDK.Tests
{
    ...
    /// <summary>
    ///Se trata de una clase de prueba para CategoryRepositoryTest y se pretende que
    ///contenga todas las pruebas unitarias CategoryRepositoryTest.
    ///</summary>
    [TestClass()]
    public class CategoryRepositoryTest
    {
        ...
        /// <summary>
        ///Una prueba de Constructor CategoryRepository
        ///</summary>
        [TestMethod()]
        public void CategoryRepositoryConstructorTest()
        {
            int localId = 0; // TODO: Inicializar en un valor adecuado
            string apiKey = string.Empty; // TODO: Inicializar en un valor adecuado
            CategoryRepository target = new CategoryRepository(localId, apiKey);
        ...
        public void AddTest()
        {
            int localId = 0; // TODO: Inicializar en un valor adecuado
            string apiKey = string.Empty; // TODO: Inicializar en un valor adecuado
            CategoryRepository target = new CategoryRepository(localId, apiKey); // TODO: Inicializar en un valor adecuado
            Category item = null; // TODO: Inicializar en un valor adecuado
            target.Add(item);
        ...
        public void CopyToTest()
        {
            ...
            string apiKey = string.Empty; // TODO: Inicializar en un valor adecuado
            CategoryRepository target = new CategoryRepository(localId, apiKey); // TODO: Inicializar en un valor adecuado
            Category[] array = null; // TODO: Inicializar en un valor adecuado
        ...
        public void GetEnumeratorTest()
        {
            ...
            string apiKey = string.Empty; // TODO: Inicializar en un valor adecuado
            CategoryRepository target = new CategoryRepository(localId, apiKey); // TODO: Inicializar en un valor adecuado
            IEnumerator<Category> expected = null; // TODO: Inicializar en un valor adecuado
        ...
        public void GetEnumeratorTest1()
        {
            int localId = 0; // TODO: Inicializar en un valor adecuado
            string apiKey = string.Empty; // TODO: Inicializar en un valor adecuado
            IEnumerable target = new CategoryRepository(localId, apiKey); // TODO: Inicializar en un valor adecuado
        ...
        public void UpdateTest()
        {
            ...
            string apiKey = string.Empty; // TODO: Inicializar en un valor adecuado
            CategoryRepository target = new CategoryRepository(localId, apiKey); // TODO: Inicializar en un valor adecuado
            Category value = null; // TODO: Inicializar en un valor adecuado
            target.Update(value);
            Assert.Inconclusive("Un método que no devuelve ningún valor no se puede comprobar.");
        }
