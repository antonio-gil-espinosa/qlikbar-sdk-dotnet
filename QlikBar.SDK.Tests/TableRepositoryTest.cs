...
namespace QlikBar.SDK.Tests
{
    ...
    /// <summary>
    ///Se trata de una clase de prueba para TableRepositoryTest y se pretende que
    ///contenga todas las pruebas unitarias TableRepositoryTest.
    ///</summary>
    [TestClass()]
    public class TableRepositoryTest
    {
        ...
        /// <summary>
        ///Una prueba de Constructor TableRepository
        ///</summary>
        [TestMethod()]
        public void TableRepositoryConstructorTest()
        {
            int localId = 0; // TODO: Inicializar en un valor adecuado
            string apiKey = string.Empty; // TODO: Inicializar en un valor adecuado
            TableRepository target = new TableRepository(localId, apiKey);
        ...
        public void AddTest()
        {
            int localId = 0; // TODO: Inicializar en un valor adecuado
            string apiKey = string.Empty; // TODO: Inicializar en un valor adecuado
            TableRepository target = new TableRepository(localId, apiKey); // TODO: Inicializar en un valor adecuado
            Table item = null; // TODO: Inicializar en un valor adecuado
            target.Add(item);
        ...
        public void CopyToTest()
        {
            ...
            string apiKey = string.Empty; // TODO: Inicializar en un valor adecuado
            TableRepository target = new TableRepository(localId, apiKey); // TODO: Inicializar en un valor adecuado
            Table[] array = null; // TODO: Inicializar en un valor adecuado
        ...
        public void GetEnumeratorTest()
        {
            ...
            string apiKey = string.Empty; // TODO: Inicializar en un valor adecuado
            TableRepository target = new TableRepository(localId, apiKey); // TODO: Inicializar en un valor adecuado
            IEnumerator<Table> expected = null; // TODO: Inicializar en un valor adecuado
            IEnumerator<Table> actual;
        ...
        public void GetEnumeratorTest1()
        {
            int localId = 0; // TODO: Inicializar en un valor adecuado
            string apiKey = string.Empty; // TODO: Inicializar en un valor adecuado
            IEnumerable target = new TableRepository(localId, apiKey); // TODO: Inicializar en un valor adecuado
        ...
        public void UpdateTest()
        {
            ...
            string apiKey = string.Empty; // TODO: Inicializar en un valor adecuado
            TableRepository target = new TableRepository(localId, apiKey); // TODO: Inicializar en un valor adecuado
            Table value = null; // TODO: Inicializar en un valor adecuado
            target.Update(value);
            Assert.Inconclusive("Un método que no devuelve ningún valor no se puede comprobar.");
        }
